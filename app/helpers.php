<?php
// funcion para los promedios finales de todos niveles.
/**
 ...
 * @return array
 */
if (!function_exists('resultado_final')) {
 ...
 * @return string
 */
if (!function_exists('resultado_concepto')) {
 ...
 * @return int
 */
if (!function_exists('calcular_sobreedad_escala')) {
 ...
 * @return float
 */
if (!function_exists('segundosToCadenaD')) {
 ...
 * @return float
 */
if (!function_exists('segundosToCadenaH')) {
 ...
 * @return int
 */
if (!function_exists('segundosToCadenaM')) {
...
if (!function_exists('segundosToCadena')) {
...
if (!function_exists('segundosToCadenaHorasMinustos')) {
...
if (!function_exists('conversor_segundos')) {
