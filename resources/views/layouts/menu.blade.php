...
<li class="side-menus">
    ...
    <!-- Enlace Ficha del Estudiante -->
    <li class="side-menus {{ Request::is('ficha-estudiante*') ? 'active' : '' }}">
        <a class="nav-link {{ Request::is('ficha-estudiante*') ? 'active' : '' }}" href="{{ url('ficha-estudiante') }}">
            <i class="fas fa-address-card"></i><span> Actualizar Ficha</span>
        </a>
    </li>
